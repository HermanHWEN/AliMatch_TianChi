...
//	public final static String PATH_OF_TRAINING_DATA="C://Match//gy_contest_link_traveltime_training_data - small.txt";
	...
	public final static int LINES_NEED_TO_READ=-1;
	public final static int SIZE_OF_TRAINING_DATA=1000;
	...
	public final static int MAX_NUM_OF_EPOCH=300;//for when epoch time reach this, will check if error is “no-improvement-in-n" 
//	public final static double THRESHOLD=0.00001;//for gradient descend
	
	
	//gradient descend
	public final static int MAX_REPEATE_TIMES=100000;//for gradient descend
	public final static boolean MUST_REACH_MAX_TIME=false;//false, will use pseudo inverse
	...
	public final static int SIZE_OF_ONE_BATCH=200;
